...
function App() {
    ...
    const activePlayer = flatGameBoard.filter((gameBoardCell) => gameBoardCell === null).length % 2 > 0 ? PLAYERS_SYMBOL[0] : PLAYERS_SYMBOL[1];
    let winnerPlayer = "";
    ...
    return (
        <article className="game-area">
            ...
            {
                (winnerPlayer || isDraw)
                && <GameOver winnerPlayer={winnerPlayer} onGameRematchClick={handleGameRematchClick} />
            }
        </article>
    );
}
